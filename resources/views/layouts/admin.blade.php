   ...
   <body>
      <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
         ...
         <div class="navbar-nav">
            <div class="nav-item text-nowrap">
              ...
              >
                <i class="mdi mdi-logout text-primary"></i> {{ __('labels.logout') }}
              </a>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mb-5 pt-2">
      ...
      <!-- Link for dashboard screen, require online link. -->
