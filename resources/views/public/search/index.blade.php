   ...
   @foreach( $products as $item )
      <div class="mb-3 col-lg-3 col-md-4" >
         <div class="card shadow-sm">
            ...
            <div class="card-body">
               <a href="{{ url('/product/'.$item->category->slug.'/'.$item->slug) }}" class="text-dark text-decoration-none">
               ...
               <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                     <a href="{{ url('/product/'.$item->category->slug.'/'.$item->slug) }}" class="btn btn-sm btn-outline-secondary">Xem</a>
                  </div>
                  <div>
